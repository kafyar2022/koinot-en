...
!1;f.gallery_hook_val=g&&e.gallery&&e.gallery_hook&&"undefined"!=typeof g.attr(e.gallery_hook)?g.attr(e.gallery_hook):!1;if(!M(c,d))return!1;if(g)b.each(f.elems,function(b,c){if(c.src==g.attr(e.src_attr))return f.elem_index=b,!1});else if(parseInt(f.elem_index,10)>=f.elems_count)return console.error("LC Lightbox - selected index does not exist"),!1;y(!1);Y();Z();f.force_fullscreen&&F(!0,!0);b("#lcl_thumbs_nav").length&&aa();y(!0);K()},N=function(){b("#lcl_wrap").removeClass("lcl_pre_show").addClass("lcl_shown");
    ...
    var c = l, d = h, e = [], f = ""; "number" == typeof document.documentMode && (b("body").addClass("lcl_old_ie"), "outer" != c.cmd_position && (c.nav_btn_pos = "normal")); b("#lcl_wrap").length && b("#lcl_wrap").remove(); b("body").append('<div id="lcl_wrap" class="lcl_pre_show lcl_pre_first_el lcl_first_sizing lcl_is_resizing"><div id="lcl_window"><div id="lcl_corner_close" title="close"></div><div id="lcl_loader" class="lcl_loader_pre_first_el"><span id="lcll_1"></span><span id="lcll_2"></span></div><div id="lcl_nav_cmd"><div class="lcl_icon lcl_prev" title="предыдущий"></div><div class="lcl_icon lcl_play"></div><div class="lcl_icon lcl_next" title="следующий"></div><div class="lcl_icon lcl_counter"></div><div class="lcl_icon lcl_right_icon lcl_close" title="закрыть"></div><div class="lcl_icon lcl_right_icon lcl_fullscreen" title="включить полноэкранный режим"></div><div class="lcl_icon lcl_right_icon lcl_txt_toggle" title="переключить текст"></div><div class="lcl_icon lcl_right_icon lcl_download" title="download"></div><div class="lcl_icon lcl_right_icon lcl_thumbs_toggle" title="переключить миниатюры"></div><div class="lcl_icon lcl_right_icon lcl_socials" title="toggle socials"></div></div><div id="lcl_contents_wrap"><div id="lcl_subj"><div id="lcl_elem_wrap"></div></div><div id="lcl_txt"></div></div></div><div id="lcl_thumbs_nav" class="lcl_pre_tn_scroll"></div><div id="lcl_overlay"></div></div>');
